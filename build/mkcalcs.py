...
CALCS = [
 dict(cid="startup", file="startup-cost-calculator.html",
      ...
      desc="Startup cost calculator. Add your one-off costs and monthly running costs and see what you need before you open. Nothing saved, nothing sent, no account.",
 ...
 dict(cid="breakeven", file="breakeven-calculator.html",
      ...
      desc="Breakeven calculator. Enter fixed costs, price and variable cost per sale to see the units and the revenue you need to cover them. Nothing saved, nothing sent.",
 ...
 dict(cid="hourly", file="hourly-rate-calculator.html",
      ...
      desc="Hourly rate calculator for freelancers and consultants. Works back from the income you want and the hours you can actually bill, not the hours you work.",
 ...
 dict(cid="pricing", file="product-pricing-calculator.html",
      ...
      desc="Product pricing calculator. Works back from the margin you want, with materials, labour, overhead and payment fees included. Nothing saved, nothing sent.",
