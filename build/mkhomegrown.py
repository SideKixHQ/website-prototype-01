...
/* the turn of the sentence, in gold. Bright rather than saturated: the heading
   is near-white, so a deep gold would read as dimmer and therefore as less
   important, which is the opposite of the job. */
.hg .punch .no{color:#FFC947}
