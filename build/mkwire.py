...
TOOLS = [
 ...
 ("state-filing.html","What Do I File in My State? LLC Lookup for All 50 | SideKix",
  "What you file to start an LLC in any US state: the office, the form, the fee, the name search, the registered agent rule and the annual report. Every figure linked to the state's own page.","monthly"),
 ("business-structures.html","Sole Proprietor vs LLC vs S Corp: Side by Side | SideKix",
  "Sole proprietor, LLC and S corporation compared on what actually differs: liability, how each is taxed, ownership limits, cost and ongoing work. Reference, not advice.","monthly"),
