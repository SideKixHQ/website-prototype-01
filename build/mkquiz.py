...
/* gold, not grey. It is a section heading and it should read as one */
.qz-more h2{font-family:var(--util,inherit);font-size:12px;letter-spacing:.22em;
  text-transform:uppercase;color:#D4A856;font-weight:700;margin:0 0 10px}
